<footer id="footer" class="footer">
    <div class="inner footer-inner">
        <div class="footer-left">
            ...
            <h4 class="footer-place">姫路市安田三丁目９３番地 アバエル１F</h4>
            <div class="footer-place__parking">
                <p class="footer-place__note">※事務所近くに駐車場（２台）をご用意しております。</p>
                <a href="https://goo.gl/maps/sXHZaFCQbocMnzus5" target="_blank" rel="noopener" class="footer-place__parkingNav">
                    <span class="footer-place__parkingNavText">駐車場ナビ</span>
                </a>
            </div>
            <a href="https://www.google.co.jp/search?q=%E3%82%A2%E3%83%BC%E3%82%AF%E8%A1%8C%E6%94%BF%E6%9B%B8%E5%A3%AB%E4%BA%8B%E5%8B%99%E6%89%80&ludocid=7149562446843799182&source=sh/x/localposts&lsig=AB86z5V3hC_dzT1f3u2PTpJJXj8N" target="_blank" rel="noopener" class="footer__link">事務所詳細はGoogle プロフィールへ</a>
            <div class="footer-accesses">
                <div class="footer-access">
                    <div class="footer-access__tag">
                        <p class="footer-access__tagText">電車をご利用の場合</p>
                    </div>
                ...
                <div class="footer-access">
                    <div class="footer-access__tag">
                        <p class="footer-access__tagText">路線バスをご利用の場合</p>
                    </div>
                    <figure class="footer-access__iconArea">
        ...
        <ul class="cta-ul">
            ...
            <li class="cta-li">
                <a href="#contact" class="cta-item">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/arc-icon-mail-beige.png" alt="メールアイコン" class="cta-item__icon">
                    <p class="cta-item__text">メールを送る</p>
                </a>
            </li>
            <li class="cta-li">
                <a href="https://lin.ee/gDSsRGq" class="cta-item">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/arc-icon-line.png" alt="LINEアイコン" class="cta-item__icon">
                    <p class="cta-item__text">LINEを送る</p>
                </a>
            </li>
        </ul>
    </div>
